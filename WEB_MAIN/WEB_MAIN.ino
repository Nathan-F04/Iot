...
float cm1, tempVal, airVal, LDist, RDist;
...
void handleRoot() {
  String message = homePagePart1 + homePagePart2 + homePagePart3 + homePagePart4 + homePagePart5 + getTemp() + homePagePart6 + homePagePart7;
  server.send(200, "text/html", message);
}
...
//Servo Function
void SerL() {
  Serial.println("Setting to Left");
...
//Servo Function
void SerR() {
  Serial.println("Setting to Right");
